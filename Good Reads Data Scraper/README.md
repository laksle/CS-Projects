...
**python chart.py**
Sample Results for [Best Sci-Fi/Fantasy Short Stories] List(https://www.goodreads.com/list/show/161527.Best_Sci_fi_Fantasy_Short_Story_Collections) in Goodreads:
